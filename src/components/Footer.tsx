...
const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-border bg-gradient-to-r from-background via-muted to-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-inner z-10">
